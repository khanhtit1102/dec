...
@section('pagetitle',__('admin.usefulnews_edit'))
...
@section('content')
<form action="{{ route('admin.usefulnews.update',$post) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card shadow mb-4">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('admin.usefulnews.index') }}" class="btn btn-warning"><i class="far fa-window-close text-white-50"></i> {{ __('admin.cancel') }}</a>
        </div>
    </div>
</form>
@endsection