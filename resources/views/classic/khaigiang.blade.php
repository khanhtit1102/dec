        ...
        <div class="row">
            <div class="col-md-4 my-2">
                <div class="khaigiang khaigianghn text-center bg-primary text-white p-4 rounded">
                    ...
                    <h5>Ngày {{ \Carbon\Carbon::parse($khaigiang->khaigiang_HN)->format('d/m/Y') }}</h5>
            ...
            <div class="col-md-4 my-2">
                <div class="khaigiang khaigianghcm text-center bg-primary text-white p-4 rounded">
                    ...
                    <h5>Ngày {{ \Carbon\Carbon::parse($khaigiang->khaigiang_HCM)->format('d/m/Y') }}</h5>
...
@push('scripts')
    <script type="text/javascript">
        ...
        var checkTime = function() {
            var kghn  = new Date("{{ \Carbon\Carbon::parse($khaigiang->khaigiang_HN)->format('m/d/Y') }} 8:00:00");
            var kghcm = new Date("{{ \Carbon\Carbon::parse($khaigiang->khaigiang_HCM)->format('m/d/Y') }} 8:00:00");
            var cTime = Date.now();
