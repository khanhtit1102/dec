  ...
  <div class="container">
    <div class="d-flex d-lg-flex">
      <div class="mobilenavbtn">
        <button class="d-lg-none btn rounded-0 btn-white p-1"><img class="navicon" src="{{ asset('images/menu.png') }}" alt="Menu đại học trực tuyến"></button>
      </div>        
      <ul class="nav d-none d-lg-flex bg-primary">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu bg-lg-primary">
